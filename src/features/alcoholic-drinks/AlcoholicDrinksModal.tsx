...
interface AlcoholicDrinksModalProps {
	name: string;
	description: string;
	price: number;
	image: string;
...
const AlcoholicDrinksModal: React.FC<AlcoholicDrinksModalProps> = ({
	name,
	description,
	price,
	image,
...
export default AlcoholicDrinksModal;
