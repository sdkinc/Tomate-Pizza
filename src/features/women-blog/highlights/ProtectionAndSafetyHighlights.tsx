...
import styles from './protectionAndSafetyHighlights.module.css';

function ProtectionAndSafetyHighlights(): JSX.Element {
	const { t } = useTranslation();
	const filteredHighlights = HighlightData.filter((tips: Highlights) =>
		tips.category.includes('Protection and Safety')
	);
...
export default ProtectionAndSafetyHighlights;
