...
import styles from './healthAndMotherhoodHighlights.module.css';
import { Highlights } from './type/HighlightsType';
import { useTranslation } from 'react-i18next';

function HealthAndMotherhoodHighlights(): JSX.Element {
	const { t } = useTranslation();
	const filteredHighlights = HighlightData.filter((tips: Highlights) =>
		tips.category.includes('Health and Motherhood')
	);
...
export default HealthAndMotherhoodHighlights;
