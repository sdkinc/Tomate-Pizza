...
import styles from './educationAndCareerHighlights.module.css';

function EducationAndCareerHighlights(): JSX.Element {
	const { t } = useTranslation();
	const filteredHighlights = HighlightData.filter((tips: Highlights) =>
		tips.category.includes('Education and Career')
	);
...
export default EducationAndCareerHighlights;
