...
import styles from './globalProjectsHighlights.module.css';

function GlobalProjectsHighlights(): JSX.Element {
	const { t } = useTranslation();
	const filteredHighlights = HighlightData.filter((tips: Highlights) =>
		tips.category.includes('Global Projects')
	);
...
export default GlobalProjectsHighlights;
