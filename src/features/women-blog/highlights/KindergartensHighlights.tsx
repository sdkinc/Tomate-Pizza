...
import styles from './kindergartens.module.css';

function KindergartensHighlights(): JSX.Element {
	const { t } = useTranslation();
	const filteredHighlights = HighlightData.filter((tips: Highlights) =>
		tips.category.includes('Kindergartens')
	);
...
export default KindergartensHighlights;
