...
interface NonAlcoholicDrinksModalProps {
	name: string;
	description: string;
	price: number;
	image: string;
...
const NonAlcoholicDrinksModal: React.FC<NonAlcoholicDrinksModalProps> = ({
	name,
	description,
	price,
	image,
...
export default NonAlcoholicDrinksModal;
