...
import styles from './houseRuleMoving.module.css';
import { useTranslation } from 'react-i18next';
import { toPng } from 'html-to-image';
import ClearIcon from '@mui/icons-material/Clear';
import { Link } from 'react-router-dom';

const image = { id: 'party_variant1', src: '/moving.webp', alt: 'Image 1' };

function HouseRuleMoving(): JSX.Element {
	...
	return (
		<div className={styles.cardsBox}>
			<h1 className={styles.titlePage}>{t('movingNoticeTitle')}</h1>
			<p className={styles.subtitlePage}>{t('movingNoticeSubtitle')}</p>
					...
					<div className={styles.leftContainer}>
						<div className={styles.letter1}>
							<div className={`${styles.letterOption}`}>
								...
								<div className={styles.textContainer}>
									{t('movingNoticeBodyParagraph1', {
										lng: i18n.language,
										movingDate: movingDate ? formatDate(movingDate, i18n.language) : '_________',
									})}
								</div>
								<div className={styles.textContainer}>
									{t('movingNoticeBodyParagraph2', {
										lng: i18n.language,
							...
							<div className={styles.nameBox}>
								<div className={styles.inputBlock}>
									<input
										...
										required
										aria-label={t('movingDatePlaceholder')}
									/>
									<span className={styles.placeholderDate}>
										{t('movingDatePlaceholder', { lng: i18n.language })}
									</span>
								</div>
								<div className={styles.inputBlock}>
									<input
						...
						<div className={styles.previewContainer} ref={previewRef}>
							...
							<div className={styles.letter}>
								...
								<div className={styles.textContainer}>
									{t('movingNoticeBodyParagraph1', {
										lng: previewLanguage,
										movingDate: movingDate ? formatDate(movingDate, previewLanguage) : '_________',
									})}
								</div>
								<div className={styles.textContainer}>
									{t('movingNoticeBodyParagraph2', {
								...
								<div className={styles.textContainer2}>
									{t('movingNoticeBodyParagraph3', { lng: previewLanguage })}
								</div>
...
export default HouseRuleMoving;
