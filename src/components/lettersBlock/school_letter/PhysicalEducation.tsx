...
import styles from './physicalEducation.module.css';
import { useTranslation } from 'react-i18next';
import { PDFDownloadLink } from '@react-pdf/renderer';
import BannerAdobeReader from '../../banner/BannerAdobeReader';
import PDFPhysicalEducation from './PDFschoolLetters/PDFPhysicalEducation';
import PhysicalEducationTipsBanner from '../../tips/PhysicalEducationTipsBanner';
import ClearIcon from '@mui/icons-material/Clear';

function PhysicalEducation(): JSX.Element {
	...
	const pdfProps = {
		title: t('physicalEducationTitleLetter', { lng: translationLanguage }),
		greeting:
		...
		bodyPart1: t('physicalEducationText1', {
			lng: translationLanguage,
	...
	return (
		<div className={styles.physicalEducationBox}>
			<h1 className={styles.titlePage}>{t('physicalEducationTitle')}</h1>
			<div className={styles.subtitlePage}>{t('physicalEducationSubtitle')}</div>
			<div className={styles.mainContainer}>
				<div className={styles.flexContainer}>
					<div className={styles.template}>
						<div className={styles.contextReviewsWrapper1}>
							<div className={styles.letter}>
								<div className={styles.titleLetter}>{t('physicalEducationTitleLetter')}</div>
						...
						<div className={styles.contextReviewsWrapper2}>
							<div className={styles.letter}>
								<div className={styles.titleLetter}>
									{t('physicalEducationTitleLetter', { lng: translationLanguage })}
								</div>
				...
				<div className={styles.buttonDownload}>
					<PDFDownloadLink
						document={<PDFPhysicalEducation {...pdfProps} />}
						fileName="physicalEducation_letter.pdf"
					>
						{({ url, loading, error }) =>
							loading ? (
				...
				<div className={styles.textBox}>
					<div className={styles.textParagraph1}>{t('physicalEducationParagraph1')}</div>
					<div className={styles.textParagraph2}>{t('physicalEducationParagraph2')}</div>
					<div className={styles.textParagraph3}>{t('physicalEducationParagraph3')}</div>
				</div>
				<div className={styles.bannerContainer}>
					<PhysicalEducationTipsBanner />
				</div>
				<div className={styles.bannerContainer}>
					<BannerAdobeReader />
				</div>
